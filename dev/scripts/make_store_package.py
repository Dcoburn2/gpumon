...
#: The repository root: the program, its icon and the storemode flag live there.
...
#: 1.0.4.0 the corrected release checksum, and 1.0.5.0 the single-file download.
VERSION = os.environ.get("GPUMON_STORE_VERSION", "1.0.5.0")
